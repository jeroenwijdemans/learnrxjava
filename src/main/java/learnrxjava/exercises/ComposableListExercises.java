...
//        throw new UnsupportedOperationException("Not implemented yet.");
    ...
    public static ComposableList<JSON> exercise03() {
        ...
        newReleases.forEach(e -> videoAndTitlePairs.add(json("id", e.id, "title", e.title)));
        // ------------ INSERT CODE HERE! ----------------------------
...
//        throw new UnsupportedOperationException("Not implemented yet.");
    ...
    */
    public static ComposableList<JSON> exercise05() {
        ...
        return newReleases.map(e -> json("id", e.id, "title", e.title));
//        throw new UnsupportedOperationException("Not implemented yet.");
    }
...
//        throw new UnsupportedOperationException("Not implemented yet.");
    ...
    public static ComposableList<Integer> exercise09() {
        ...
        movieLists.forEach(ml -> ml.videos.map(v -> allVideoIdsInMovieLists .add(v.id)));
...
//        throw new UnsupportedOperationException("Not implemented yet.");
        ...
        ComposableList<MovieList> movieLists = ComposableListExercises.of(new MovieList(
                ...
                new MovieList(
                        ...
                        ComposableListExercises.of(
                                ...
                                new Video(675465, "Fracture", 5.0))));
        // ------------   INSERT CODE HERE!  -----------------------------------
        // Use map and concatMap to flatten the movieLists in a list of video ids.
        // ------------   INSERT CODE HERE!  -----------------------------------
    ...
    */
    public static ComposableList<JSON> exercise12() {
        ...
        // Use one or more map, concatMap, and filter calls to create an ComposableList with the following items
        // {
